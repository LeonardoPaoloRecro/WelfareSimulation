...
function renderLongRunChart() {
  ...
  const panels = [
    { key: "gdpPerCapita", title: "GDP per capita" },
    { key: "coreWelfareFromBase", title: "Core welfare (1929 = 0)" },
    { key: "unemploymentPercent", title: "Unemployment (%)" },
    { key: "government", title: "Government spending" }
  ];
  ...
  const traces = [
    {
      ...
      yaxis: "y",
      name: "GDP per capita",
      line: { color: BENCHMARK_COLORS.core, width: 2.6 },
    ...
    },
    {
      ...
      yaxis: "y2",
      name: "Core welfare",
      line: { color: DERIVED_COLORS.coreWelfare, width: 2.6 },
    ...
    },
    {
      ...
      yaxis: "y3",
      name: "Unemployment",
      line: { color: BENCHMARK_COLORS.output, width: 2.5 },
    ...
    },
    {
      ...
      yaxis: "y4",
      name: "Government spending",
      line: { color: SERIES_BY_KEY.get("government").color, width: 2.6 },
